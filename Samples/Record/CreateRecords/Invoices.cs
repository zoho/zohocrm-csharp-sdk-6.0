...
namespace Samples.Record.CreateRecords
{
	public class Invoices
	{
		public static void CreateInvoices_1(string module)
		{
			...
			accountname.AddFieldValue(Com.Zoho.Crm.API.Record.Accounts.ID, 440248884001L);
	...
	//		inventoryLineItem.AddKeyValue("Product_Category_1", "hardware");
			...
			productLineTax.Percentage = 10.0;
			productLineTaxes.Add (productLineTax);
			inventoryLineItem.AddKeyValue("Line_Tax", productLineTaxes);
			inventoryLineItemList.Add (inventoryLineItem);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.INVOICED_ITEMS, inventoryLineItemList);
			...
			fileDetail1.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab7c6d90b0bd44183d280";
			fileDetails.Add (fileDetail1);
			FileDetails fileDetail2 = new FileDetails();
			fileDetail2.FileIdS = "ae9c7cefa35c32e0063e7321b5b4ca878a934519e6cdb2";
		...
		public static void Call()
		{
			try
			{
                ...
                CreateInvoices_1(moduleAPIName);
			}
			catch (Exception e)
			{
