...
namespace Samples.Record.Updaterecords
{
	...
	{
		public static void UpdateSalesOrders_1(string module)
		{
			...
			deal_name.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.ID, 3212431324313L);
			...
			contact_name.AddFieldValue(Com.Zoho.Crm.API.Record.Contacts.ID, 32343533322342L);
			...
			List<Com.Zoho.Crm.API.Record.Record> inventoryLineItemList2 = new List<Com.Zoho.Crm.API.Record.Record>();
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.ORDERED_ITEMS, inventoryLineItemList2);
			...
			// Address info
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.BILLING_CITY, "city");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.BILLING_CODE, "12345");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.BILLING_COUNTRY, "country");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.BILLING_STATE, "state");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.BILLING_STREET, "street");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.SHIPPING_CITY, "shipping city");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.SHIPPING_CODE, "shipping code");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.SHIPPING_COUNTRY, "shipping country");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.SHIPPING_STATE, "shipping state");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.SHIPPING_STREET, "shipping street");
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateSalesOrders_1(moduleAPIName);
			}
			catch (Exception e)
			{
