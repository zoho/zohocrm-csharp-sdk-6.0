...
namespace Samples.Record.Updaterecords
{
	...
	{
		public static void UpdateSolutions_1(string moduleAPIName)
		{
			RecordOperations recordOperations = new RecordOperations(moduleAPIName);
			BodyWrapper bodyWrapper = new BodyWrapper();
			List<Com.Zoho.Crm.API.Record.Record> records = new List<Com.Zoho.Crm.API.Record.Record>();
			Com.Zoho.Crm.API.Record.Record record1 =  new Com.Zoho.Crm.API.Record.Record();
			record1.Id = 39034223024324;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Solutions.SOLUTION_TITLE, "new Solution");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Solutions.STATUS, new Choice<string>("Draft"));
			Com.Zoho.Crm.API.Record.Record product =  new Com.Zoho.Crm.API.Record.Record();
			product.Id = 3456064049533L;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Solutions.PRODUCT_NAME, product);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Solutions.QUESTION, "question?");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Solutions.ANSWER, "answer");
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateSolutions_1(moduleAPIName);
			}
			catch (Exception e)
			{
