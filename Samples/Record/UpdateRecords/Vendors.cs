...
namespace Samples.Record.Updaterecords
{
	...
	{
		public static void UpdateVendors_1(string module)
		{
			...
			record1.Id = 23245234364525L;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.VENDOR_NAME, "vendor_name");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.PHONE, "12343213");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.EMAIL, "abc@zoho.com");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.WEBSITE, null);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.GL_ACCOUNT, new Choice<string>("Sales-Software"));
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.CATEGORY, null);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.CITY, "city");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.COUNTRY, "country");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.STATE, "state");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.STREET, "street");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.ZIP_CODE, "zipcode");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Vendors.DESCRIPTION, "description");
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
		...
		public static void Call()
		{
			try
			{
				...
				string moduleAPIName = "Vendors";
                UpdateVendors_1(moduleAPIName);
			}
			catch (Exception e)
			{
