...
namespace Com.Zoho.Crm.API.Currencies
{
	...
	public class CurrenciesOperations
	{
		...
		public APIResponse<ResponseHandler> GetCurrencies()
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v6/org/currencies");
		...
		/// <summary>The method to enable base currency</summary>
		/// <param name="request">Instance of BaseCurrencyWrapper</param>
		/// <returns>Instance of APIResponse<ActionHandler></returns>
		public APIResponse<ActionHandler> EnableBaseCurrency(BaseCurrencyWrapper request)
		{
			CommonAPIHandler handlerInstance=new CommonAPIHandler();

			string apiPath="";

			apiPath=string.Concat(apiPath, "/crm/v6/org/currencies/actions/enable");
