...
namespace Com.Zoho.Crm.API.DealContactRoles
{
	...
	public class Data : Record.Record , Model
	{
		...
		public ContactRole ContactRole
		{
			...
			/// <returns>Instance of ContactRole</returns>
			get
			{
				if((( this.GetKeyValue("Contact_Role")) != (null)))
				{
					return (ContactRole) this.GetKeyValue("Contact_Role");
			...
			/// <param name="contactRole">Instance of ContactRole</param>
			set
			{
				 this.AddKeyValue("Contact_Role", value);
