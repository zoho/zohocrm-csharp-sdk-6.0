...
namespace Com.Zoho.Crm.API.Holidays
{
	...
	public class CreateBusinessHoliday : Model, BodyWrapper
	{
		private List<BusinessHoliday> holidays;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<BusinessHoliday> Holidays
		{
			/// <summary>The method to get the holidays</summary>
			/// <returns>Instance of List<BusinessHoliday></returns>
			get
			{
			...
			/// <param name="holidays">Instance of List<BusinessHoliday></param>
			set
			{
				 this.holidays=value;
