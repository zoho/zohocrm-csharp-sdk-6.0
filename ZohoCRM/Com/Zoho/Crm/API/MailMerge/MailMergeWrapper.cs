...
namespace Com.Zoho.Crm.API.MailMerge
{
	...
	public class MailMergeWrapper : Model
	{
		private List<MailMerge> sendMailMerge;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<MailMerge> SendMailMerge
		{
			/// <summary>The method to get the sendMailMerge</summary>
			/// <returns>Instance of List<MailMerge></returns>
			get
			{
			...
			/// <param name="sendMailMerge">Instance of List<MailMerge></param>
			set
			{
