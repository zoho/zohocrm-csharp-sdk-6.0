...
namespace Com.Zoho.Crm.API.Record
{
	...
	public class RecurringActivity : Model
	{
		...
		{
			/// <summary>The method to get the exdate</summary>
			/// <returns>string representing the exdate</returns>
			get
			{
				return  this.exdate;

			}
			/// <summary>The method to set the value to exdate</summary>
			/// <param name="exdate">string</param>
			set
			{
				 this.exdate=value;
