...
namespace Com.Zoho.Crm.API.UsersUnavailability
{
	...
	public class ResponseWrapper : Model, ResponseHandler
	{
		...
		public List<UsersUnavailability> UsersUnavailability
		{
			/// <summary>The method to get the usersUnavailability</summary>
			/// <returns>Instance of List<UsersUnavailability></returns>
			get
			{
			...
			/// <param name="usersUnavailability">Instance of List<UsersUnavailability></param>
			set
			{
