...
namespace Com.Zoho.Crm.API.Fields
{
	...
	{
		private int? startingNumberLength;
		private string prefix;
		private string suffix;
		private int? startNumber;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public int? StartingNumberLength
		{
			/// <summary>The method to get the startingNumberLength</summary>
			/// <returns>int? representing the startingNumberLength</returns>
			get
			{
				return  this.startingNumberLength;

			}
			/// <summary>The method to set the value to startingNumberLength</summary>
			/// <param name="startingNumberLength">int?</param>
			set
			{
				 this.startingNumberLength=value;
