...
namespace Com.Zoho.Crm.API.Files
{
	...
	{
		private List<StreamWrapper> file;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<StreamWrapper> File
		{
			/// <summary>The method to get the file</summary>
			/// <returns>Instance of List<StreamWrapper></returns>
			get
			{
				return  this.file;
			...
			/// <param name="file">Instance of List<StreamWrapper></param>
			set
			{
				 this.file=value;
