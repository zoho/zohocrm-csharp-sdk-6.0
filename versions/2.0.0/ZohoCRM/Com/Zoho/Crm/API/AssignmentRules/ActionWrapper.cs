...
namespace Com.Zoho.Crm.API.AssignmentRules
{
	...
	{
		private List<APIException> assignmentRules;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<APIException> AssignmentRules
		{
			/// <summary>The method to get the assignmentRules</summary>
			/// <returns>Instance of List<APIException></returns>
			get
			{
			...
			/// <param name="assignmentRules">Instance of List<APIException></param>
			set
			{
