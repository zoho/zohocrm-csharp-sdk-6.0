...
namespace Com.Zoho.Crm.API.BulkWrite
{
	...
	public class FieldMapping : Model
	{
		...
		public DefaultValue DefaultValue
		{
			...
			/// <returns>Instance of DefaultValue</returns>
			get
			{
			...
			/// <param name="defaultValue">Instance of DefaultValue</param>
			set
			{
		...
		{
			/// <summary>The method to get the parentColumnIndex</summary>
			/// <returns>int? representing the parentColumnIndex</returns>
			get
			{
				return  this.parentColumnIndex;

			}
			/// <summary>The method to set the value to parentColumnIndex</summary>
			/// <param name="parentColumnIndex">int?</param>
			set
			{
				 this.parentColumnIndex=value;
