...
namespace Com.Zoho.Crm.API.ConvertLead
{
	...
	{
		private List<LeadConverter> data;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<LeadConverter> Data
		{
			/// <summary>The method to get the data</summary>
			/// <returns>Instance of List<LeadConverter></returns>
			get
			{
				return  this.data;
			...
			/// <param name="data">Instance of List<LeadConverter></param>
			set
			{
				 this.data=value;
