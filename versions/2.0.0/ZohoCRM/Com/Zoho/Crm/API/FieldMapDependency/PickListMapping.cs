...
namespace Com.Zoho.Crm.API.FieldMapDependency
{
	...
	public class PickListMapping : Model
	{
		private long? id;
		...
		public List<PicklistMap> Maps
		{
			/// <summary>The method to get the maps</summary>
			/// <returns>Instance of List<PicklistMap></returns>
			get
			{
				return  this.maps;
			...
			/// <param name="maps">Instance of List<PicklistMap></param>
			set
			{
				 this.maps=value;
