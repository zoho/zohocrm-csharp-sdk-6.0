...
namespace Com.Zoho.Crm.API.Modules
{
	...
	public class ModuleFields : Fields.Fields , Model
	{
		...
		private Fields.AutoNumber autoNumber64;
		...
		public SharingProperties SharingProperties
		{
		...
		public List<MinifiedModule> AllowedModules
		{
		...
		public MinifiedModule AssociatedModule
		{
		...
		public MinifiedModule SubModule
		{
		...
		public Fields.AutoNumber AutoNumber64
		{
			/// <summary>The method to get the autoNumber64</summary>
			/// <returns>Instance of AutoNumber</returns>
			get
			{
			...
			/// <summary>The method to set the value to autoNumber64</summary>
			/// <param name="autoNumber64">Instance of AutoNumber</param>
			set
			{
				 this.autoNumber64=value;
