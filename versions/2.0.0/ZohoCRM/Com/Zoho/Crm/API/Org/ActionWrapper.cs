...
namespace Com.Zoho.Crm.API.Org
{
	...
	{
		private List<SuccessResponse> org;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<SuccessResponse> Org
		{
			/// <summary>The method to get the org</summary>
			/// <returns>Instance of List<SuccessResponse></returns>
			get
			{
				return  this.org;
			...
			/// <param name="org">Instance of List<SuccessResponse></param>
			set
			{
				 this.org=value;
