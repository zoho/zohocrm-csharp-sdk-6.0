...
namespace Com.Zoho.Crm.API.Org
{
	...
	public class LicenseDetails : Model
	{
		...
		public int? UsersLicensePurchased
		{
			...
			/// <returns>int? representing the usersLicensePurchased</returns>
			get
			{
			...
			/// <param name="usersLicensePurchased">int?</param>
			set
			{
		...
		{
			/// <summary>The method to get the trialAction</summary>
			/// <returns>string representing the trialAction</returns>
			get
			{
				return  this.trialAction;

			}
			/// <summary>The method to set the value to trialAction</summary>
			/// <param name="trialAction">string</param>
			set
			{
				 this.trialAction=value;
