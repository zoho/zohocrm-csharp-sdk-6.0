...
namespace Com.Zoho.Crm.API.UsersTerritories
{
	...
	public class TransferWrapper : Model
	{
		private List<TransferAndDelink> transferAndDelink;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<TransferAndDelink> TransferAndDelink
		{
			/// <summary>The method to get the transferAndDelink</summary>
			/// <returns>Instance of List<TransferAndDelink></returns>
			get
			{
			...
			/// <param name="transferAndDelink">Instance of List<TransferAndDelink></param>
			set
			{
