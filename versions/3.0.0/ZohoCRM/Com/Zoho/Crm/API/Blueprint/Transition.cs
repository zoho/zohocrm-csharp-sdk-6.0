...
namespace Com.Zoho.Crm.API.Blueprint
{
	...
	public class Transition : Model
	{
		...
		private int? percentPartialSave;
		...
		public int? Sequence
		{
			/// <summary>The method to get the sequence</summary>
			/// <returns>int? representing the sequence</returns>
			get
			{
				return  this.sequence;

			}
			/// <summary>The method to set the value to sequence</summary>
		...
		public int? PercentPartialSave
		{
			/// <summary>The method to get the percentPartialSave</summary>
			/// <returns>int? representing the percentPartialSave</returns>
			get
			{
			...
			/// <param name="percentPartialSave">int?</param>
			set
			{
		...
		{
			/// <summary>The method to get the textColorCode</summary>
			/// <returns>string representing the textColorCode</returns>
			get
			{
				return  this.textColorCode;

			}
			/// <summary>The method to set the value to textColorCode</summary>
			/// <param name="textColorCode">string</param>
			set
			{
				 this.textColorCode=value;
