...
using GetRecordsHeader = Com.Zoho.Crm.API.Record.RecordOperations.GetRecordsHeader;
using GetRecordsParam = Com.Zoho.Crm.API.Record.RecordOperations.GetRecordsParam;
...
namespace Samples.Record
{
	...
	{
		public static void GetRecords_1(string moduleAPIName)
		{
