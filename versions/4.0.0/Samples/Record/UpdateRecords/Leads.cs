...
namespace Samples.Record.Updaterecords
{
	public class Leads
	{
		public static void UpdateLeads_1(string module)
		{
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Leads.WEBSITE, null);
