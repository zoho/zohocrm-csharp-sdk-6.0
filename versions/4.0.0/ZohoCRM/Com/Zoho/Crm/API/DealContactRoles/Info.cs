...
namespace Com.Zoho.Crm.API.DealContactRoles
{
	...
	public class Info : Model
	{
		...
		private string pageTokenExpiry;
		...
		public string PageTokenExpiry
		{
			/// <summary>The method to get the pageTokenExpiry</summary>
			/// <returns>string representing the pageTokenExpiry</returns>
			get
			{
			...
			/// <param name="pageTokenExpiry">string</param>
			set
			{
