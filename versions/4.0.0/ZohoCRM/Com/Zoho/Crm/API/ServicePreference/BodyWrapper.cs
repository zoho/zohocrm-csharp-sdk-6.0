...
namespace Com.Zoho.Crm.API.ServicePreference
{
	...
	{
		private ServicePreference servicePreferences;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public ServicePreference ServicePreferences
		{
			/// <summary>The method to get the servicePreferences</summary>
			/// <returns>Instance of ServicePreference</returns>
			get
			{
			...
			/// <param name="servicePreferences">Instance of ServicePreference</param>
			set
			{
