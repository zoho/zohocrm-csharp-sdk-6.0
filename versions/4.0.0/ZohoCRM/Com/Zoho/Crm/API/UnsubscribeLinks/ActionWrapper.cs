...
namespace Com.Zoho.Crm.API.UnsubscribeLinks
{
	...
	{
		private List<ActionResponse> unsubscribeLinks;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<ActionResponse> UnsubscribeLinks
		{
			...
			/// <param name="unsubscribeLinks">Instance of List<ActionResponse></param>
			set
			{
