...
namespace Samples.Record.CreateRecords
{
	public class Deals
	{
		public static void CreateDeals_1(string module)
		{
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.DEAL_NAME, "deal_name");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.AMOUNT, 100.0);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.CLOSING_DATE, new DateTime(2023, 12, 12).Date);
			Com.Zoho.Crm.API.Record.Record account =  new Com.Zoho.Crm.API.Record.Record();
			account.Id = 31212001L;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.ACCOUNT_NAME, account);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.STAGE, new Choice<string>("Qualification"));
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.PROBABILITY, 10);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.TYPE, new Choice<string>("New Business"));
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.NEXT_STEP, null);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.LEAD_SOURCE, new Choice<string>("Advertisement"));
			Com.Zoho.Crm.API.Record.Record contactName =  new Com.Zoho.Crm.API.Record.Record();
			contactName.Id = 40223200342313L;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.CONTACT_NAME, contactName);
			Com.Zoho.Crm.API.Record.Record compaign =  new Com.Zoho.Crm.API.Record.Record();
			compaign.Id = 322311243223L;
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.CAMPAIGN_SOURCE, compaign);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.DESCRIPTION, "description");
			...
			fileDetail1.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad87c6bd44183d280";
			fileDetails.Add (fileDetail1);
			FileDetails fileDetail2 = new FileDetails();
			fileDetail2.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321b878a934519e6cdb2";
