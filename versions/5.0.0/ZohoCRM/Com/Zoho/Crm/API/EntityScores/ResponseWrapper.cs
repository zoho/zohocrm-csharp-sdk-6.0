...
namespace Com.Zoho.Crm.API.EntityScores
{
	...
	{
		private List<EntityScores> data;
		private Info info;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<EntityScores> Data
		{
			/// <summary>The method to get the data</summary>
			/// <returns>Instance of List<EntityScores></returns>
			get
			{
				return  this.data;
			...
			/// <param name="data">Instance of List<EntityScores></param>
			set
			{
				 this.data=value;
