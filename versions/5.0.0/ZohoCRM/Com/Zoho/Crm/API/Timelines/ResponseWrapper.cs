...
namespace Com.Zoho.Crm.API.Timelines
{
	...
	public class ResponseWrapper : Model, ResponseHandler
	{
		...
		{
			/// <summary>The method to get the timeline</summary>
			/// <returns>Instance of List<Timeline></returns>
			get
			{
				return  this.timeline;

			}
			/// <summary>The method to set the value to timeline</summary>
			/// <param name="timeline">Instance of List<Timeline></param>
			set
			{
				 this.timeline=value;
