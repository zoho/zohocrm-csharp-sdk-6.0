...
namespace Samples.Record.CreateRecords
{
	...
	{
		public static void CreateContacts_1(string module)
		{
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Contacts.DATE_OF_BIRTH, new DateTime(2023, 12, 01).Date);
			...
			fileDetail1.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad87c6d9083d280";
			fileDetails.Add (fileDetail1);
			FileDetails fileDetail2 = new FileDetails();
			fileDetail2.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321b5a934519e6cdb2";
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
		...
		public static void Call()
		{
			try
			{
                ...
                CreateContacts_1(moduleAPIName);
			}
			catch (Exception e)
			{
