...
namespace Samples.Record.CreateRecords
{
	...
	{
		public static void CreatePriceBooks_1(string moduleAPIName)
		{
			...
			fileDetail1.FileIdS = "ae9c7cefa418aec1d6a6ae23d729ad87c6d90b0bd44183d280";
			fileDetails.Add (fileDetail1);
			FileDetails fileDetail2 = new FileDetails();
			fileDetail2.FileIdS = "ae9c75cc2d9ab35c32e0063e7321b5b4ca878a934519e6cdb2";
	...
	//		headerInstance.Add (CreateRecordsHeader.X_EXTERNAL, "Quotes.Quoted_Items.Product_Name.Products_External");
		...
		public static void Call()
		{
			try
			{
                ...
                CreatePriceBooks_1(moduleAPIName);
			}
			catch (Exception e)
			{
