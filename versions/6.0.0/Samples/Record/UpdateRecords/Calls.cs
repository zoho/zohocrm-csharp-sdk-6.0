...
namespace Samples.Record.Updaterecords
{
	public class Calls
	{
		public static void UpdateCall_1(string moduleAPIName)
		{
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Calls.CALL_PURPOSE, new Choice<string>("Demo"));
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Calls.CALL_AGENDA, "agenda to make call");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Calls.CALL_RESULT, "Not interested");
