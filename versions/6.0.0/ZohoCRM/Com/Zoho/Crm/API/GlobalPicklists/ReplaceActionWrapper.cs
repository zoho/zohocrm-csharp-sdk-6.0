...
namespace Com.Zoho.Crm.API.GlobalPicklists
{
	...
	public class ReplaceActionWrapper : Model, ReplaceActionHandler
	{
		private List<ReplaceActionResponse> replacePicklistValues;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<ReplaceActionResponse> ReplacePicklistValues
		{
			/// <summary>The method to get the replacePicklistValues</summary>
			/// <returns>Instance of List<ReplaceActionResponse></returns>
			get
			{
			...
			/// <param name="replacePicklistValues">Instance of List<ReplaceActionResponse></param>
			set
			{
