...
namespace Com.Zoho.Crm.API.Tags
{
	...
	public class ExistingTagRequestWrapper : Model
	{
		private List<ExistingTag> tags;
		private List<long?> ids;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<ExistingTag> Tags
		{
			/// <summary>The method to get the tags</summary>
			/// <returns>Instance of List<ExistingTag></returns>
			get
			{
				return  this.tags;
			...
			/// <param name="tags">Instance of List<ExistingTag></param>
			set
			{
				 this.tags=value;
