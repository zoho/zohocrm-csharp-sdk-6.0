...
namespace Com.Zoho.Crm.API.Territories
{
	...
	public class DeletedAssociatedWrapper : Model
	{
		private List<DeletedAssociatedTerritories> territories;
		private Info info;
		private Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<DeletedAssociatedTerritories> Territories
		{
			/// <summary>The method to get the territories</summary>
			/// <returns>Instance of List<DeletedAssociatedTerritories></returns>
			get
			{
			...
			/// <param name="territories">Instance of List<DeletedAssociatedTerritories></param>
			set
			{
