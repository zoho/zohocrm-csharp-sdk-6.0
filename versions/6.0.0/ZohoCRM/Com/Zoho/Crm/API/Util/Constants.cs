...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public static class Constants
    {
        ...
        public static readonly string SDK_VERSION = "6.0.0";
        ...
        public static readonly string CHOICE = "Com.Zoho.Crm.API.Util.Choice`1[[$type]], ZOHOCRMSDK-6.0";
        ...
        public static readonly string RECORD_TYPE = "Com.Zoho.Crm.API.Record.Record, ZOHOCRMSDK-6.0";
        ...
        public static readonly string SUB_TYPE = "sub-type";
        ...
        public static readonly List<string> SET_CONTENT_TYPE_HEADER = new List<string> { "/crm/bulk/v6/read", "/crm/bulk/v6/write" };
        ...
        public static readonly List<string>  CA_DATACENTER = new List<string>() { "https://www.zohoapis.ca", "https://sandbox.zohoapis.ca", "https://developer.zohoapis.ca", "https://accounts.zoho.ca/oauth/v2/token", "ca" };
        ...
        public static readonly string SUB_TYPE_1 = "sub_type";
    }
}
