...
namespace Samples.Record.CreateRecords
{
	public class Cases
	{
		public static void CreateCases_1(string module)
		{
			...
			product_name.AddKeyValue("id", 32133465231321L);
			...
			contactName.AddKeyValue("id", 3121012312232L);
			...
			fileDetail1.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad8";
			fileDetails.Add (fileDetail1);
			FileDetails fileDetail2 = new FileDetails();
			fileDetail2.FileIdS = "ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321b52";
