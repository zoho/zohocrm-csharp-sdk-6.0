...
namespace Samples.Record.Updaterecords
{
	...
	{
		public static void UpdateInvoices_1(string module)
		{
			...
			record1.Id = 3345498598275042L;
			accountname.AddKeyValue("name", "automated");
	//		accountname.AddFieldValue(Field.Accounts.ID, 440248884001L);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.ACCOUNT_NAME, accountname);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.SUBJECT, "new invoice");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.ADJUSTMENT, 10.0);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.INVOICE_DATE, new DateTime(2023, 10, 12).Date);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.DUE_DATE, new DateTime(2023, 12, 12).Date);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.SALES_COMMISSION, 20.0);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.PURCHASE_ORDER, "purchase order");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.EXCISE_DUTY, 10.0);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.STATUS, new Choice<string>("Created"));
			...
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.CONTACT_NAME, contactname);
			Com.Zoho.Crm.API.Record.Record dealname =  new Com.Zoho.Crm.API.Record.Record();
			dealname.AddFieldValue(Com.Zoho.Crm.API.Record.Deals.ID, 347706111383007);
			record1.AddKeyValue("Deal_Name__s", dealname);
			Com.Zoho.Crm.API.Record.Record sales_order =  new Com.Zoho.Crm.API.Record.Record();
			sales_order.AddFieldValue(Com.Zoho.Crm.API.Record.Sales_Orders.ID, 32203232899292L);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.SALES_ORDER, sales_order);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.TERMS_AND_CONDITIONS, "details of terms and conditions");
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.DESCRIPTION, "description");
			List<Com.Zoho.Crm.API.Record.Record> inventoryLineItemList3 = new List<Com.Zoho.Crm.API.Record.Record>();
			Com.Zoho.Crm.API.Record.Record inventoryLineItem3 =  new Com.Zoho.Crm.API.Record.Record();
			LineItemProduct lineItemProduct3 = new LineItemProduct();
			lineItemProduct3.Id = 440248954344L;
	//		Com.Zoho.Crm.API.Record.Record data =  new Com.Zoho.Crm.API.Record.Record();
	//		data.Id = 440248954344L;
			inventoryLineItem3.AddKeyValue("Description", "asd");
			inventoryLineItem3.AddKeyValue("Discount", "5");
			inventoryLineItem3.AddKeyValue("Quantity", 10.0);
			inventoryLineItem3.AddKeyValue("List_Price", 100.0);
			inventoryLineItem3.AddKeyValue("Product_Name", lineItemProduct3);
	//		inventoryLineItem3.AddKeyValue("Product_Category_1", "hardware");
			inventoryLineItemList3.Add (inventoryLineItem3);
			record1.AddFieldValue(Com.Zoho.Crm.API.Record.Invoices.INVOICED_ITEMS, inventoryLineItemList3);
	...
	//		bodyWrapper.LarId = "3477061087515";
		...
		public static void Call()
		{
			try
			{
                ...
                UpdateInvoices_1(moduleAPIName);
			}
			catch (Exception e)
			{
