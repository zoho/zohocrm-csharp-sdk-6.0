...
namespace Com.Zoho.Crm.API.Files
{
	...
	public class FilesOperations
	{
		...
		public APIResponse<ActionHandler> UploadFiles(BodyWrapper request, ParameterMap paramInstance)
		{
			...
			apiPath=string.Concat(apiPath, "/crm/v6/files");
		...
		{
			public static readonly Param<string> TYPE=new Param<string>("type", "com.zoho.crm.api.Files.UploadFilesParam");
		}


		public static class UploadFilesHeader
		{
		}
		...
		{
			public static readonly Param<string> ID=new Param<string>("id", "com.zoho.crm.api.Files.GetFileParam");
		}
